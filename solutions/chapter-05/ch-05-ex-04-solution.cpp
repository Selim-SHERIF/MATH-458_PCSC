...
void mean_and_std(const double *const v, const double size, double &mean,
                  double &stdev) {
  mean = 0.0;
 ...
 */
void mean_and_std_rec(const double *const v, const double size, double &mean,
                      double &stdev) {
...
int main(int argc, char *argv[]) {
  if (argc == 1) {
    std::cout << "Please input a series of floating point numbers:\n"
              << "   ./ch-05-ex-04-solution 5.0 4.8 5.3 2.9" << std::endl;
    return -1;
  }
  ...
  std::cout << "The mean and standard deviation are: " << mean << " and "
